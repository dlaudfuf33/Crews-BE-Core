...
public class AuthController {
     ...
     *
     * @param issueApikeyRequestDto 구독 요청을 위한 DTO
    ...
    public ResponseEntity<IssueApikeyResponsetDto> addSubscription(@RequestBody IssueApikeyRequestDto issueApikeyRequestDto) {
        // 구독 요청 처리 및 API 키 발급
        IssueApikeyResponsetDto responseDto = subscribeService.createSubscription(issueApikeyRequestDto);
