...
public class AuthController {
     ...
     *
     * @param issueApikeyRequest 구독 요청을 위한 DTO
    ...
    public ResponseEntity<IssueApikeyResponset> addSubscription(@RequestBody IssueApikeyRequest issueApikeyRequest) {
        // 구독 요청 처리 및 API 키 발급
        IssueApikeyResponset responseDto = subscribeService.createSubscription(issueApikeyRequest);
